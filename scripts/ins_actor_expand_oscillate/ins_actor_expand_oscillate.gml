//function ins_actor_expand_oscillate(_actor, _factor, _speed) {
...
//			ins.complete = true;
//			ins_actor_contract_oscillate(ins.actor, ins.factor, ins.spd);
//		}
//	}
//	push_ins(ins);
//}
...
function ins_actor_expand_oscillate(_actor, _factor, _speed) {
	...
	_actor.fn = function(args) {
		...
		&& (args.target[0].yy >= 0 && point_index[0].yy >= args.target[0].yy)) {
			ins_actor_contract_oscillate(id, args.factor, args.spd);
